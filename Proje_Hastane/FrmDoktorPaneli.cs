...
namespace Proje_Hastane
{
    public partial class FrmDoktorPaneli : Form
    {
        ...
        private void BtnEkle_Click(object sender, EventArgs e)
        {
            ...
            bgl.baglanti().Close();
            MessageBox.Show("Doktor bilgileri eklendi!","Bilgi",MessageBoxButtons.OK,MessageBoxIcon.Information);
        }
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            bgl.baglanti().Close();
            MessageBox.Show("Doktor bilgileri silindi!", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Stop);
        }
